<?php
// Script temporaire pour exécuter la migration depuis le dossier API (accessible publiquement)
...
try {
    ...
    // Remonter de 2 niveaux depuis api/tuteurs/ (donc dans backend/uploads)
