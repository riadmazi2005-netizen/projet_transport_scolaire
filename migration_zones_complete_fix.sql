-- Migration complète pour les zones avec correction de la colonne 'ville'
...
-- Méthode compatible MySQL 5.7+ et MariaDB
...
-- Étape 3: Insérer les zones avec leurs villes
-- Rabat – 8 zones
